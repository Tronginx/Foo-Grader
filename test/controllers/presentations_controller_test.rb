...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { author: @presentation.author, comment: @presentation.comment, grade: @presentation.grade, time: @presentation.time, title: @presentation.title } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { author: @presentation.author, comment: @presentation.comment, grade: @presentation.grade, time: @presentation.time, title: @presentation.title } }
